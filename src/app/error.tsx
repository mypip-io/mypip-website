      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <PostItNote rotation={1} color="pink" className="inline-block mb-8">
          <div className="text-center">
            <div className="text-lg font-bold mb-2">Don't worry!</div>
            <div className="text-sm">These things happen. Let's try again.</div>
          </div>
        </PostItNote>

        <div className="space-y-6">
          <p className="text-lg text-ink-blue/80">
            Looks like something unexpected happened. Even the best notebooks have smudges sometimes.
          </p>
